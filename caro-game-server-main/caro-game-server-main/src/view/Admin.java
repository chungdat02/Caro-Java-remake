...
public class Admin extends javax.swing.JFrame implements Runnable{
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Chọn lý do", "Ghét quá nên ban :) ", "Cố ý để thua, nâng hạng cho đối thủ :v", "Ngôn ngữ thô tục - xúc phạm người khác", "Spam đăng nhập", "Sử dụng game với mục đích xấu", "Phát hiện rò rỉ bảo mật - tài khoản tạm thời bị khoá để kiểm tra thêm", " " }));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(rootPane, "User đang off");
        }
    ...
    private void sendMessage(){
        ...
        temp+= "Thông báo từ máy chủ Admin : "+message+"\n";
