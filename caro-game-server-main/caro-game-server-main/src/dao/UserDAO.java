...
public class UserDAO extends DAO{
    ...
    //Ham regggggggggg
    public boolean registerUser(String username, String password, String nickname, String avatar) {
        if (checkDuplicated(username)) {
            // Tên người dùng đã tồn tại, không thể đăng ký
            return false;
        } else {
            try {
                ...
                ex.printStackTrace();
                return false; // Lỗi khi thực hiện đăng ký
            }
        }
    }
